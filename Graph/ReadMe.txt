...
res\Toolbar.bmp
    ...
    update the IDR_MAINFRAME TOOLBAR array in Graph.rc to add
    toolbar buttons.
/////////////////////////////////////////////////////////////////////////////
...
GraphDoc.h, GraphDoc.cpp - the document
    ...
    The Document will have the following strings:
        ...
        File type ID:        Graph.Document
        Main frame caption:  Graph
        Doc type name:       Graph
        Filter name:         Graph Files (*.fig)
        File new short name: Graph
        File type long name: Graph Document
